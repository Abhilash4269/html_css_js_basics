...
let m3 = new Movie("BatmanBegins", "DC", "PG")
let m4 = new Movie("Spiderman", "Marvel", "UG")
let m5 = new Movie("Superman", "dc", "A")
let m = new Movie()
let mx = [m1, m2, m3, m4, m5]

console.log(m.getPG(mx))
